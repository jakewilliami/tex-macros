...
\begin{document}
	...
	\addplot[mark=none,domain=0:370,samples=300,smooth,thick] {abs(cos(2*x/2))};
	\end{polaraxis}
	\draw[redtea,thick] (n1.90) arc (-100:370:1cm);
	\draw[redtea,thick] (n2.180) arc (100:450:1cm);
	...
	\node at (n2)[circle,fill,inner sep=0.7em]{};
